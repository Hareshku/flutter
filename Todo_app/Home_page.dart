...
import 'package:todo_app/secondscreen.dart';
            ...
            actions: <Widget>[
              ...
              PopupMenuButton(
                itemBuilder: (BuildContext context) {
                  return [
                    const PopupMenuItem(child: Text('A')),
                    const PopupMenuItem(child: Text('B')),
                    const PopupMenuItem(child: Text('C')),
                    const PopupMenuItem(child: Text('D')),
                  ];
                },
              ),
            ],
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.of(context).pushNamed(
                            // MaterialPageRoute(builder: (context)=> const SecondScreen(data: "data from home",),
                            // ),
                            "/second"
                          );
                        },
